(() => {
  ...
  function loadCurrentHubAssets(){
    ...
    script("gameDayPlayerPulseScript","./gameday-player-pulse-windowed.js?v=20260914a");
    ...
    script("gameDayPulseFinalRankingScript","./gameday-pulse-final-ranking.js?v=20260914a");
